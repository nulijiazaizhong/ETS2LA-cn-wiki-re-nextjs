  ...
  return (
    <main className="flex justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="prose dark:prose-invert max-w-7.45xl">
        ...
        <Typography variant="h2" id="redefine-journey">
          重新定义您的虚拟货运旅程
        </Typography>
        <p>
          欢迎来到ETS2LA的世界！我们是一个致力于为SCS
          Software开发的卡车模拟游戏带来尖端自动驾驶技术的开源项目。
          <sup>12</sup>{' '}
          无论您是《欧洲卡车模拟2》(Euro Truck Simulator 2)
          的老司机，还是《美国卡车模拟》(American Truck Simulator)
          的新玩家，ETS2LA都将为您带来前所未有的驾驶体验。
        </p>

        <Typography variant="h2" id="our-mission">
          我们的使命
        </Typography>
        <Typography variant="h3" id="innovation-exploration">
          创新与探索
        </Typography>
        <p>
          我们相信，游戏的世界拥有无限可能。我们的核心使命是突破《欧洲卡车模拟2》和《美国卡车模拟》的界限，通过引入先进的辅助驾驶功能，为玩家提供一种全新的、更轻松的探索虚拟世界的方式。
        </p>
        <Typography variant="h3" id="freedom-free">
          自由与免费
        </Typography>
        <p>
          ETS2LA是一个完全免费的开源项目，并且将永远如此。<sup>3</sup>{' '}
          我们致力于为整个社区提供价值，让每一位玩家都能享受到技术带来的乐趣。
        </p>

        <Typography variant="h2" id="core-technology">
          核心技术
        </Typography>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            ...
            与依赖视觉识别的传统方案不同，ETS2LA通过插件直接从游戏中提取关键的路况和地图数据。
            这使得它能够在各种天气和光线条件（甚至是完全的黑夜）下，精准地处理复杂的交通状况，如环岛、交通信号灯和无保护转弯。
          </li>
          <li>
            <strong>现代化的用户界面:</strong>{' '}
            我们从现实世界的自动驾驶方案中汲取灵感，为您打造了一个美观、现代且功能强大的用户界面。
            <sup>1</sup>{' '}
            您可以轻松地在第二块屏幕或平板电脑上显示实时路况和车辆状态。
          </li>
          <li>
            <strong>持续进化:</strong> ETS2LA
            2.0版本标志着我们向全自动驾驶迈出了重要一步，实现了从出发点到目的地的自动导航。
            但我们的脚步从未停止，开发团队仍在不断修复错误、添加新功能。
          </li>
        </ul>

        <Typography variant="h2" id="our-team">
          我们的团队
        </Typography>
        ...
        <p>
          我们不是一家公司，而是一群由充满热情的程序员、卡车模拟爱好者和技术宅组成的全球性开源社区。
          <sup>6</sup>{' '}
          我们在GitHub上协作，利用业余时间贡献代码和创意，共同推动这个项目的成长。我们相信，开放和协作是创造卓越产品的最佳方式。
        </p>

        <Typography variant="h2" id="join-our-journey">
          加入我们的旅程
        </Typography>
        <p>
        ...
        <Typography variant="h2" id="support-us">
          支持我们 (Support Us)
        </Typography>
        <p>
