...
export default function Page() {
  return (
    <>
      ...
      <Typography variant="h2">安装程序打不开</Typography>
      <Typography>
      ...
      <Typography variant="h2">安装时显示错误消息</Typography>
      <Typography>
      ...
      <Typography variant="h3"><code>WARNING: Retrying (Retry(total=4...</code></Typography>
      <Typography>
      ...
      <Typography variant="h3"><code>fatal: destination path '.' already exists and is not an empty directory.</code></Typography>
      <Typography>
        这意味着您尝试将 ETS2LA 安装到的目录不为空。如果您没有更改任何设置，则应删除 <code>C：\ETS2LA</code> 文件夹并重试
      </Typography>
      <Typography variant="h3"><code>fatal: unable to access '...'</code></Typography>
      <Typography>
        这意味着安装程序无法连接到您选择的下载镜像。请检查您的互联网连接并确保您可以访问至少一个镜像。通常，国内用户可以通过选择CNB仓库来解决这个问题
      </Typography>
      <Typography variant="h3"><code>warning: Could not find remote branch rewrite to clone.</code></Typography>
      <Typography>
      ...
      <Typography variant="h2">安装程序完全崩溃</Typography>
      <Typography>
