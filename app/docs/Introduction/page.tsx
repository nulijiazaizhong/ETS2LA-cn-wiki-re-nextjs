...
export default function IntroductionPage() {
  ...
  return (
    <>
      ...
      <Typography variant="h2" id="features">
        特征
      </Typography>

      <Typography variant="h3" id="data-access">
        完全访问模拟器数据
      </Typography>
      <Typography variant="p">
      ...
      <Typography variant="h3" id="multi-language">
        多语言支持
      </Typography>
      <Typography variant="p">
      ...
      <Typography variant="h3" id="seamless-navigation">
        无缝导航
      </Typography>
      <Typography variant="p">
      ...
      <Typography variant="h3" id="no-ai">
        无需昂贵的 AI 模型
      </Typography>
      <Typography variant="p">
        ETS2LA
      ...
      <Typography variant="h3" id="dev-experience">
        丰富的开发经验
      </Typography>
      <Typography variant="p">
        ETS2LA
